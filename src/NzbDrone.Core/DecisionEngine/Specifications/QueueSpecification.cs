    ...
    public class QueueSpecification : IDecisionEngineSpecification
    {
        ...
        public Decision IsSatisfiedBy(RemoteEpisode subject, SearchCriteriaBase searchCriteria)
        {
            ...
            foreach (var remoteEpisode in matchingEpisode)
            {
                ...
                if (!_upgradableSpecification.CutoffNotMet(subject.Series.Profile, remoteEpisode.ParsedEpisodeInfo.Quality, remoteEpisode.ParsedEpisodeInfo.Language, subject.ParsedEpisodeInfo.Quality))
                {
                ...
                if (!_upgradableSpecification.IsUpgradable(subject.Series.Profile, remoteEpisode.ParsedEpisodeInfo.Quality, remoteEpisode.ParsedEpisodeInfo.Language, subject.ParsedEpisodeInfo.Quality, subject.ParsedEpisodeInfo.Language))
                {
