...
namespace NzbDrone.Core.Test.ParserTests.NewParser
{
    ...
    public class DailyEpisodeParserFixture : CoreTest<NewParseProvider>
    {
        ...
        [TestCase("2011.01.10 - Denis Leary - HD TV.mkv", "Denis Leary", 2011, 1, 10)]
        [TestCase("2011.03.13 - Denis Leary - HD TV.mkv", "Denis Leary", 2011, 3, 13)]
        ...
        public void should_not_accept_future_dates(string title)
        {
            ...
            Subject.ParseTitle(validDate).Should().BeNull();
        }
