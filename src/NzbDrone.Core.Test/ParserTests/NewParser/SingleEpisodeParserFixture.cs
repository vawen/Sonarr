...
namespace NzbDrone.Core.Test.ParserTests.NewParser
{
    ...
    [TestFixture]
    [Category("ParserTest")]
    public class SingleEpisodeParserFixture : CoreTest<NewParseProvider>
    {
        [SetUp]
        public void Setup()
        {
        ...
        [TestCase("House - S06E01 - 5 to 9 [DVD]", "House", 6, 1)]
        //[TestCase("", "", 0, 0)]
        public void should_parse_single_episode(string postTitle, string title, int seasonNumber, int episodeNumber)
        {
            ...
            var ep = Builder<Episode>.CreateListOfSize(episodeNumber + 1).Build().ToList();
