...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class SingleEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("The Big Bang Theory (PROPER) - Temporada 8 [HDTV][Cap.822][Español Spanish]", "The Big Bang Theory", 8, 22)]
        [TestCase("Anatomia De Grey - Temporada 11 [HDTV][Cap.1120][Español Spanish]", "Anatomia De Grey", 11, 20)]
        [TestCase("Bones - Temporada 10 [HDTV][Cap.1016][Español Spanish] NEWPCT", "Bones", 10, 16)]
