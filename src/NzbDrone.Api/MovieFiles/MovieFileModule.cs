...
namespace NzbDrone.Api.MovieFiles
{
    ...
    {
        private readonly IMovieMediaFileService _mediaFileService;
        ...
        public MovieFileModule(IBroadcastSignalRMessage signalRBroadcaster,
                              IMovieMediaFileService mediaFileService,
        ...
        {
            var movieFile = _mediaFileService.Get(id);
        ...
        {
            var movieFile = _mediaFileService.Get(movieFileResource.Id);
